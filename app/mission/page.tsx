...
import { MOCK_USER, MOCK_MISSIONS } from "@/mock/data";
...
export default function MissionListPage() {
  const completedCount = MOCK_MISSIONS.filter((m) => m.completed_today).length;
      ...
      <div className="px-4 pt-5 pb-4">
        ...
        <div className="mt-4 bg-white rounded-2xl p-4 shadow-sm">
          <div className="flex justify-between items-center mb-2">
            ...
            <span className="text-xs font-bold text-[#E5002B]">{completedCount}/{MOCK_MISSIONS.length}</span>
          </div>
